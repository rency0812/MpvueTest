  ...
  <div class="navigation">
    ...
    <div class="nav-item" v-show="showNavigation">
      <div class="navigation-left" @click="showNav">
        <a href="../homepage/homepage">主页</a>
      </div>
      <div class="navigation-right">
        <div @click="showNav">
          <a class="nav-list" href="../blog/blog" :class="{ 'router-link-active' : blog }">新浪博客</a>
        </div>
        <div @click="showNav">
          <a class="nav-list" href="../error/error?id=1" :class="{ 'router-link-active' : error == 'weibo' }">新浪微博</a>
        </div>
        <div @click="showNav">
